...
-----   ----------   -----------   -------------------------------------------------------------------------------
1.0     02/05/2021   Douglas Matias       1. Built this table for LDS BC IT243
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description'
                              , @value = N'Account Branch Description.'
                              , @level0type = N'SCHEMA'
                              , @level0name = N'dbo'
                              , @level1type = N'TABLE'
                              , @level1name = N'stg_p1'
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description'
                              , @value = N'Date Customer Created Account.'
                              , @level0type = N'SCHEMA'
                              , @level0name = N'dbo'
                              , @level1type = N'TABLE'
                              , @level1name = N'stg_p1'
...
EXEC sys.sp_addextendedproperty @name = N'MS_Description'
                              , @value = N'Current Customer Request Index.'
                              , @level0type = N'SCHEMA'
                              , @level0name = N'dbo'
                              , @level1type = N'TABLE'
                              , @level1name = N'stg_p2'
